                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="side9">
                                                        <ul class="sidemenu-list">
                                                            ...
                                                            <li class="mega-menu">
                                                                <div class="">
                                                                    <ul>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/alerts" class="slide-item"> Alerts</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/buttons" class="slide-item"> Buttons</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/colors" class="slide-item"> Colors</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/avatar-square" class="slide-item"> Avatar Square</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/avatar-radius" class="slide-item"> Avatar Radius</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/avatar-round" class="slide-item"> Avatar Rounded</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/dropdown" class="slide-item"> Dropdowns</a></li>
                                                                    </ul>
                                                                </div>
                                                                <div class="">
                                                                    <ul>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/listgroup" class="slide-item"> List Group</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/tags" class="slide-item"> Tags</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/pagination" class="slide-item"> Pagination</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/navigation" class="slide-item"> Navigation</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/typography" class="slide-item"> Typography</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/breadcrumbs" class="slide-item"> Breadcrumbs</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/badge" class="slide-item"> Badges / Pills</a></li>
                                                                    </ul>
                                                                </div>
                                                                <div class="">
                                                                    <ul>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/thumbnails" class="slide-item"> Thumbnails</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/offcanvas" class="slide-item"> Offcanvas</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/toast" class="slide-item"> Toast</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/scrollspy" class="slide-item"> Scrollspy</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/mediaobject" class="slide-item"> Media Object</a></li>
                                                                    </ul>
                                                                </div>
                                                                <div class="">
                                                                    <ul>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/accordion" class="slide-item"> Accordions </a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/tabs" class="slide-item"> Tabs</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/modal" class="slide-item"> Modal</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/tooltipandpopover" class="slide-item"> Tooltip and popover</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/progress" class="slide-item"> Progress</a></li>
                                                                        <li><a href="https://laravelui.spruko.com/sparic/carousel" class="slide-item"> Carousels</a></li>
                                                                    </ul>
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div class="tab-pane" id="side12">
                                                        ...
                                                        <div class="list-group-item d-flex px-0 border-0 align-items-center">
                                                            <div class="me-2">
                                                                <span class="avatar avatar-md brround cover-image" data-image-src="https://laravelui.spruko.com/sparic/build/assets/images/users/female/2.jpg" style="background: url(https://laravelui.spruko.com/sparic/build/assets/images/users/female/2.jpg) center center;"></span>
                                                            </div>
                                                            <div class="lh-1">
                                                        ...
                                                        <div class="list-group-item d-flex px-0 border-0 align-items-center">
                                                            <div class="me-2">
                                                                <span class="avatar avatar-md brround cover-image" data-image-src="https://laravelui.spruko.com/sparic/build/assets/images/users/female/6.jpg" style="background: url(https://laravelui.spruko.com/sparic/build/assets/images/users/female/6.jpg) center center;"></span>
                                                            </div>
                                                            <div class="lh-1">
                                                        ...
                                                        <div class="list-group-item d-flex px-0 border-0 align-items-center">
                                                            <div class="me-2">
                                                                <span class="avatar avatar-md brround cover-image" data-image-src="https://laravelui.spruko.com/sparic/build/assets/images/users/male/5.jpg" style="background: url(https://laravelui.spruko.com/sparic/build/assets/images/users/male/5.jpg) center center;"></span>
                                                            </div>
                                                            <div class="lh-1">
                                                        ...
                                                        <div class="list-group-item d-flex px-0 border-0 align-items-center">
                                                            <div class="me-2">
                                                                <span class="avatar avatar-md brround cover-image" data-image-src="https://laravelui.spruko.com/sparic/build/assets/images/users/male/6.jpg" style="background: url(https://laravelui.spruko.com/sparic/build/assets/images/users/male/6.jpg) center center;"></span>
                                                            </div>
                                                            <div class="lh-1">
                                                                <h6 class="fw-semibold fs-13">Isidro Heide</h6>
                                                                <p class="text-muted fs-10 mb-0">Web Designer
                                                        ...
                                                        <div class="list-group-item d-flex px-0 border-0 align-items-center">
                                                            <div class="me-2">
                                                                <span class="avatar avatar-md brround cover-image" data-image-src="https://laravelui.spruko.com/sparic/build/assets/images/users/male/2.jpg" style="background: url(https://laravelui.spruko.com/sparic/build/assets/images/users/male/2.jpg) center center;"></span>
                                                            </div>
                                                            <div class="lh-1">
                                                                <h6 class="fw-semibold fs-13">Isidro Heide</h6>
                                                                <p class="text-muted fs-10 mb-0">Web Designer
                                                        ...
                                                        <div class="list-group-item d-flex px-0 border-0 align-items-center">
                                                            <div class="me-2">
                                                                <span class="avatar avatar-md brround cover-image" data-image-src="https://laravelui.spruko.com/sparic/build/assets/images/users/male/4.jpg" style="background: url(https://laravelui.spruko.com/sparic/build/assets/images/users/male/2.jpg) center center;"></span>
                                                            </div>
                                                            <div class="lh-1">
                                                                <h6 class="fw-semibold fs-13">Isidro Heide</h6>
                                                                <p class="text-muted fs-10 mb-0">Web Designer
                                                        ...
                                                        <div class="list-group-item d-flex px-0 border-0 align-items-center">
                                                            <div class="me-2">
                                                                <span class="avatar avatar-md brround cover-image" data-image-src="https://laravelui.spruko.com/sparic/build/assets/images/users/male/5.jpg" style="background: url(https://laravelui.spruko.com/sparic/build/assets/images/users/male/2.jpg) center center;"></span>
                                                            </div>
                                                            <div class="lh-1">
                                                                <h6 class="fw-semibold fs-13">Isidro Heide</h6>
                                                        ...
                                                        <div class="list-group-item d-flex px-0 border-0 align-items-center">
                                                            <div class="me-2">
                                                                <span class="avatar avatar-md brround cover-image" data-image-src="https://laravelui.spruko.com/sparic/build/assets/images/users/female/3.jpg" style="background: url(https://laravelui.spruko.com/sparic/build/assets/images/users/female/3.jpg) center center;"></span>
                                                            </div>
                                                            <div class="lh-1">
                                                        ...
                                                        <ul class="sidemenu-list">
                                                            ...
                                                            <li class="sub-slide">
                                                                ...
                                                                <ul class="sub-slide-menu">
                                                                    <li><a href="https://laravelui.spruko.com/sparic/form-elements" class="sub-slide-item"> Form Elements</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/form-layouts" class="sub-slide-item"> Form Layouts</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/form-advanced" class="sub-slide-item"> Form Advanced</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/form-editor" class="sub-slide-item"> Form Editor</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/form-wizard" class="sub-slide-item"> Form Wizard</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/form-validation" class="sub-slide-item"> Form Validation</a></li>
                                                                </ul>
                                                            </li>
                                                            <li class="sub-slide">
                                                                <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                                                    href="javascript:void(0)"><span class="sub-side-menu__label">Tables</span><i
                                                                        class="sub-angle fe fe-chevron-right"></i></a>
                                                                <ul class="sub-slide-menu">
                                                                    <li><a href="https://laravelui.spruko.com/sparic/tables" class="sub-slide-item">Default table</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/datatable" class="sub-slide-item"> Data Tables</a></li>
                                                                </ul>
                                                            </li>
                                                            <li class="sub-slide">
                                                                <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                                                ...
                                                                <ul class="sub-slide-menu">
                                                                    <li><a href="https://laravelui.spruko.com/sparic/filemanager" class="sub-slide-item"> Filemanager</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/filemanager-list" class="sub-slide-item"> Filemanager List</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/filemanager-details" class="sub-slide-item"> File Details</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/file-attachments" class="sub-slide-item"> File Attachments</a></li>
                                                                </ul>
                                                            </li>
                                                        </ul>
                                                        <div class="resp-tab-content-active">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="side17">
                                                        <ul class="sidemenu-list">
                                                            ...
                                                            <li><a href="https://laravelui.spruko.com/sparic/profile" class="slide-item"> Profile</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/notify-list" class="slide-item"> Notifications List</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/time-line" class="slide-item"> Timeline </a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/email-compose" class="slide-item"> Mail-Compose</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/email-inbox" class="slide-item"> Mail-Inbox</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/email-read" class="slide-item"> Mail-Read</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/gallery" class="slide-item"> Gallery</a></li>
                                                            <li class="sub-slide">
                                                                <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                                                    href="javascript:void(0)"><span
                                                                        ...
                                                                        class="sub-angle fe fe-chevron-right"></i></a>
                                                                <ul class="sub-slide-menu">
                                                                    <li><a href="https://laravelui.spruko.com/sparic/about" class="sub-slide-item"> About Company</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/services" class="sub-slide-item"> Services</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/faq" class="sub-slide-item"> FAQS</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/terms" class="sub-slide-item"> Terms</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/invoice" class="sub-slide-item"> Invoice</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/pricing" class="sub-slide-item"> Pricing Tables</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/settings" class="sub-slide-item"> Settings</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/blog" class="sub-slide-item"> Blog</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/blog-details" class="sub-slide-item"> Blog Details</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/blog-post" class="sub-slide-item"> Blog Post</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/empty-page" class="sub-slide-item"> Empty Page</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/construction" class="sub-slide-item"> Under Construction</a></li>
                                                                </ul>
                                                            </li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/switcher" class="slide-item"> Switcher</a></li>
                                                        </ul>
                                                        <div class="resp-tab-content-active">
                                                            <h6 class="fw-semibold mb-4">Active Users</h6>
                                                            <div class="row">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="side21">
                                                        <ul class="sidemenu-list">
                                                            ...
                                                            <li><a href="https://laravelui.spruko.com/sparic/shop" class="slide-item"> Shop</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/product-details" class="slide-item"> Product Details</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/cart" class="slide-item"> Shopping Cart</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/add-product" class="slide-item"> Add Product</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/wishlist" class="slide-item"> Wishlist</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/checkout" class="slide-item"> Checkout</a></li>
                                                        </ul>
                                                        <div class="resp-tab-content-active">
                                                            <h6 class="fw-semibold mb-4">Active Users</h6>
                                                            <div class="row">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="side25">
                                                        <ul class="sidemenu-list">
                                                            ...
                                                            <li><a href="https://laravelui.spruko.com/sparic/login" class="slide-item"> Login</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/register" class="slide-item"> Register</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/forgot-password" class="slide-item"> Forgot Password</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/lockscreen" class="slide-item"> Lock screen</a></li>
                                                            <li class="sub-slide">
                                                                <a class="sub-side-menu__item" data-bs-toggle="sub-slide"
                                                                    href="javascript:void(0)"><span class="sub-side-menu__label">Error
                                                                        Pages</span><i class="sub-angle fe fe-chevron-right"></i></a>
                                                                <ul class="sub-slide-menu">
                                                                    <li><a href="https://laravelui.spruko.com/sparic/error400" class="sub-slide-item"> 400</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/error401" class="sub-slide-item"> 401</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/error403" class="sub-slide-item"> 403</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/error404" class="sub-slide-item"> 404</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/error500" class="sub-slide-item"> 500</a></li>
                                                                    <li><a href="https://laravelui.spruko.com/sparic/error503" class="sub-slide-item"> 503</a></li>
                                                                </ul>
                                                            </li>
                                                        </ul>
                                                        <div class="resp-tab-content-active">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="side33">
                                                        <ul class="sidemenu-list">
                                                            ...
                                                            <li><a href="https://laravelui.spruko.com/sparic/maps1" class="slide-item">Leaflet Maps</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/maps2" class="slide-item">Mapel Maps</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/maps" class="slide-item">Vector Maps</a></li>
                                                        </ul>
                                                        <div class="resp-tab-content-active">
                                                            <h6 class="fw-semibold mb-4">Active Users</h6>
                                                            <div class="row">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="side37">
                                                        <ul class="sidemenu-list">
                                                            ...
                                                            <li><a href="https://laravelui.spruko.com/sparic/chart-chartist" class="slide-item">Chart Js</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/chart-flot" class="slide-item"> Flot Charts</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/chart-echart" class="slide-item"> ECharts</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/chart-morris" class="slide-item"> Morris Charts</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/chart-nvd3" class="slide-item"> Nvd3 Charts</a></li>
                                                        </ul>
                                                        <div class="resp-tab-content-active">
                                                            <h6 class="fw-semibold mb-4">Active Users</h6>
                                                            <div class="row">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="side41">
                                                        <ul class="sidemenu-list">
                                                            ...
                                                            <li><a href="https://laravelui.spruko.com/sparic/icons" class="slide-item"> Font Awesome</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/icons2" class="slide-item"> Material Design Icons</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/icons3" class="slide-item"> Simple Line Icons</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/icons4" class="slide-item"> Feather Icons</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/icons5" class="slide-item"> Ionic Icons</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/icons6" class="slide-item"> Flag Icons</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/icons7" class="slide-item"> pe7 Icons</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/icons8" class="slide-item"> Themify Icons</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/icons9" class="slide-item">Typicons Icons</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/icons10" class="slide-item">Weather Icons</a></li>
                                                            <li><a href="https://laravelui.spruko.com/sparic/icons11" class="slide-item">Bootstrap Icons</a></li>
                                                        </ul>
                                                        <div class="resp-tab-content-active">
                                                            <h6 class="fw-semibold mb-4">Active Users</h6>
                                                            <div class="row">
