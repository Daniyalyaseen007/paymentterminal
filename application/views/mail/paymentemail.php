...
<div class="u-row-container" style="padding: 60px 0px 0px;background-color: transparent">
...
<!--[if (mso)|(IE)]></td><![endif]-->
 ...
 <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;"><!--<![endif]-->
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
      <td style="padding-right: 0px;padding-left: 0px; padding-top:0px;" align="center">

        <h3 align="center" border="0"  style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 70%;font-family:poppins;font-weight: 500;font-size:25px;text-transform:uppercase;margin-bottom:4px;margin-top:0px"> transaction Details </h3>
      </td>
    </tr>
  </table>
