                                        ...
                                        <div class="card-body">
                                            <div class="d-flex flex-column">
                                                <div class="form-group">
                                                    <input class="form-control" placeholder="Enter Merchant Name For Sales Team Like 1.0 or 2.0"
                                                        type="text">
                                                </div>
                                                <div class="form-group">
                                                    <input class="form-control" placeholder="Enter Real Merchant Name Stripe or Paypal" type="email">
                                                </div>
                                                <div class="form-group">
                                                    <input class="form-control" placeholder="Enter Payment Link like https://checkout.xetrocube.co.uk/token/" type="email">
                                                </div>
                                                <div class="form-group">
