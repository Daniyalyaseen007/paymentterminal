                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex flex-column">
                                                <form method="post" action="<?=base_url()?>services/edit_process">
                                                  <div class="form-group">
                                                        <input value="<?=$SearchServices[0]["ServiceName"]?>" required name="ServiceName" class="form-control" placeholder="Enter Service Name" type="text">
                                                        <input value="<?=$SearchServices[0]["ServiceID"]?>" required name="ServiceID" class="form-control" placeholder="Enter Service Name" type="hidden">
                                                    </div>
